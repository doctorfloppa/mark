...
library.theme = {
    ...
    backgroundcolor = Color3.fromRGB(0, 122, 99),
    tabstextcolor = Color3.fromRGB(154, 217, 224),
    bordercolor = Color3.fromRGB(0, 114, 133),
    accentcolor = Color3.fromRGB(0, 122, 99),
    accentcolor2 = Color3.fromRGB(0, 122, 99),
    outlinecolor = Color3.fromRGB(0, 114, 113),
    outlinecolor2 = Color3.fromRGB(0, 114, 113),
    sectorcolor = Color3.fromRGB(0, 122, 99),
    toptextcolor = Color3.fromRGB(154, 217, 224),
    topheight = 48,
    topcolor = Color3.fromRGB(0, 122, 99),
    topcolor2 = Color3.fromRGB(0, 122, 99),
    buttoncolor = Color3.fromRGB(0, 122, 99),
    buttoncolor2 = Color3.fromRGB(0, 122, 99),
    itemscolor = Color3.fromRGB(0, 122, 99),
    itemscolor2 = Color3.fromRGB(0, 122, 99)
}
